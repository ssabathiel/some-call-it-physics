...
public class TEXPreferenceEditor : Editor
{
    ...
    void DrawViewerSigned(Rect drawRect)
    {
#if TEXDRAW_TMP
    ...
    bool CustomToggle(Rect r, bool value, GUIContent content, GUIStyle style)
    {
